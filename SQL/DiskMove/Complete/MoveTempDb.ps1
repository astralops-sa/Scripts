...
$SQLServiceAccount = ""
    try {
        ...
        $result =  Invoke-SqlCmdUtil -ServerInstance $SqlInstance -Query $query
...
$result = Invoke-SqlCmdUtil -ServerInstance $SqlInstance -Query $checkTempdbQuery
...
if (($tempdbSizeMB + $SafetyMarginMB) -gt $freeSpaceMB) {
...
"@
$result = Invoke-SqlCmdUtil -ServerInstance $SqlInstance -Query $getFileQuery
...
Invoke-SqlCmdUtil -ServerInstance $SqlInstance -Query $alterScript | Out-Null
