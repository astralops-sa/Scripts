...
try {
    ...
    foreach ($entry in $Config.disks) {
            ...
            $Job = Start-Job -ScriptBlock {
                ...
                & $ScriptLocation}\ChangeDisks.ps1 -OldDrive $OldDrive -NewDrive $NewDrive -TempDrive $TempDrive -LogFolder $LogFolder
            ...
            } -ArgumentList $oldDrive, $newDrive, $tempDrive, $LogFolder
